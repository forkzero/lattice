...
pub use storage::{
    ...
    LATTICE_DIR, RefineOptions, RefineResult, ResolveOptions, VerifyOptions, add_implementation,
    add_requirement, add_source, add_thesis, find_lattice_root, find_node_path, get_git_user,
    init_lattice, load_all_nodes, load_nodes_by_type, refine_requirement, resolve_node,
